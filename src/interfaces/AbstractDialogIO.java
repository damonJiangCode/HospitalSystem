...
/**
 * A partially implemented class with the input and output methods to read a
 * String, read an int,
 * output a message, and display a list of choices from which the user must
 * select the index of a
...
public abstract class AbstractDialogIO implements InputOutputInterface {
    /**
     * Display the list of options and read an int that is the index of one of the
     * options. The
     * first option is the default.
     *
     * @param options an array with the options that are presented to the user
     * @return the int specifying the array index for the option selected by the
     *         user
     */
