...
/**
 * The panel to obtain data for the creation of a doctor, and to cause the
...
public class DoctorAddPanel extends JPanel {
    ...
    /**
     * Create the panel to obtain data for the creation of a doctor, and to cause
     * the doctor to be
     * created.
     */
    public DoctorAddPanel() {
        ...
        // add a panel with the field for the entry of checking the doctor is surgeon or
        // not
