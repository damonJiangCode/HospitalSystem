...
/**
 * The panel for the operations involving doctors. There is a button to add a
 * new doctor, a field
 * to access a specific doctor, a button to list all doctors, and an exit button
 * to hide the
 * window with this frame.
 */
public class DoctorOpsPanel extends JPanel {
    /**
     * Create the panel for the operations involving doctors. There is a button to
     * add a new
     * doctor, a field to access a specific doctor, a button to list all doctors,
     * and an exit
    ...
    public DoctorOpsPanel() {
        ...
        // add a button to display all the doctor
