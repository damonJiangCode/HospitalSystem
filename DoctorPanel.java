 ...
 * panel gives the doctor's name. The patients of the doctor are given, and the user has the option to add another patient or
 * remove a patient.
 */
public class DoctorPanel extends JPanel {
    /**
     * Create the panel to display the doctor's information and accept operations on the patient.
     *
    ...
    /**
     * Fill in the panel to display the patient's information and accept operations on the doctor.
     *
